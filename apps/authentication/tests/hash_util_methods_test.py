...
class TestPasswordUtilMethods(TestCase):
    def setUp(self):
        ...
        self.hashed_password = hash_string_with_secret_key(self.password)
    ...
    def test_when_verify_string_then_returns_true_for_valid_string(self):
        self.assertTrue(verify_strings(self.hashed_password, self.password))

    def test_when_verify_string_then_returns_false_for_invalid_string(self):
        self.assertFalse(verify_strings(self.hashed_password, "invalid_password"))
